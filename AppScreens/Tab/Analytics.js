...
const Analytics = () => {
  ...
  const getMonthlyData = type => {
    ...
    return [
      {
        value: thisMonthTotal || 0.1,
        color: type === 'INCOME' ? '#34C759' : '#FF3B30',
      },
      {
        value: lastMonthTotal || 0.1,
        color: type === 'INCOME' ? '#5856D6' : '#FF9F0A',
      },
    ];
  };
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.compareContainer}>
            <View style={styles.compareCard}>
              ...
              <PieChart widthAndHeight={120} series={incomeData} cover={0.65} />
              <View style={styles.monthlyData}>
                <Text style={styles.monthlyText}>
                  Current month - $
                  {incomeData[0]?.value === 100 ? 0 : incomeData[0]?.value || 0}
                </Text>
                <Text style={styles.monthlyText}>
            ...
            <View style={styles.compareCard}>
              ...
              <View style={styles.monthlyData}>
                <Text style={styles.monthlyText}>
                  Current month - $
                  {expensesData[0]?.value === 100
                    ? 0
                    : expensesData[0]?.value || 0}
                </Text>
                <Text style={styles.monthlyText}>
